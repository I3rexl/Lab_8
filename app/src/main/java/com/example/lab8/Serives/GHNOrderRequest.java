...
public class GHNOrderRequest {
    ...
    private String note, required_note, return_phone, return_address, to_name, to_phone, to_address, to_ward_code;
    private int to_district_id, cod_amount;
    private String content;
    private int weight, length, width, height, pick_station_id, insurance_value, service_id, service_type_id;
    private ArrayList<GHNItem> items;

    public GHNOrderRequest() {
    }

    public GHNOrderRequest(int payment_type_id, String note, String required_note, String return_phone, String return_address, String to_name, String to_phone, String to_address, String to_ward_code, int to_district_id, int cod_amount, String content, int weight, int length, int width, int height, int pick_station_id, int insurance_value, int service_id, int service_type_id, ArrayList<GHNItem> items) {
